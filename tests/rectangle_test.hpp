#ifndef __RECTANGLE_TEST__
#define __RECTANGLE_TEST__
...
TEST(Constructor_Test, defaultRectangle)
{
        ...
        EXPECT_EQ(rectangle->get_width(), 0);
        EXPECT_EQ(rectangle->get_height(), 0);
}

TEST(Constructor_Test, basicRectangle)
{
        Rectangle* rectangle = new Rectangle(4, 5);
        EXPECT_EQ(rectangle->get_width(), 4);
        EXPECT_EQ(rectangle->get_height(), 5);
}
